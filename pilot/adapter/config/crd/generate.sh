...
CRDS="MockConfig RouteRule V1alpha2RouteRule IngressRule Gateway EgressRule DestinationPolicy V1alpha2DestinationPolicy HTTPAPISpec HTTPAPISpecBinding QuotaSpec QuotaSpecBinding EndUserAuthenticationPolicySpec EndUserAuthenticationPolicySpecBinding"
